		      ...
		      ArrayList<Integer> myArray = new ArrayList<Integer>();
				...
				ExcelApiTest3 eat1 = new ExcelApiTest3();
				 ...
				 {	
					 ...
					 CellData6=eat1.getCellData(xlsFile,xlsFileSheet,i,6);
					 System.out.println("CellData6-"+CellData6);
					 
							 if (CellData6.equals("Pass"))
							 {
								 PassCount++;
							 }
							 else
		    ...
		    //  String CellData1="",CellData2="",CellData3="",CellData4="",CellData5="",CellData6="";
			 ...
			 {	
				...
				// System.out.println("CellData5-"+CellData5);
				 ...
				 CellData5=eat1.getCellData(xlsFile,xlsFileSheet,i,6);
				 System.out.println("CellData6-"+CellData5);                // Pass or Fail
				 
				 
				 TestCaseEndDateTime=eat1.getCellData(xlsFile,xlsFileSheet,i,7);
				 System.out.println("TestCaseEndDateTime :"+TestCaseEndDateTime); //TestCaseEndDateTime
				 
				 DurationPrint=eat1.getCellData(xlsFile,xlsFileSheet,i,8);
